...
# Все схемы РЕАЛЬНО меняют цвета (как в первой версии!)
COLOR_SCHEMES = [
    # Теплые тона (1-10)
    {"name": "Золотой_рассвет", "hue": 15},
    {"name": "Закатный", "hue": 12},
    {"name": "Янтарный", "hue": 18},
    {"name": "Медовый", "hue": 20},
    {"name": "Персиковый", "hue": 10},
    {"name": "Коралловый", "hue": 8},
    {"name": "Теплый_песок", "hue": 14},
    {"name": "Осенний", "hue": 16},
    {"name": "Рыжий", "hue": 22},
    {"name": "Карамельный", "hue": 11},

    # Холодные тона (11-20)
    {"name": "Морозный", "hue": -15},
    {"name": "Голубой_час", "hue": -20},
    {"name": "Ледяной", "hue": -18},
    {"name": "Бирюзовый", "hue": -25},
    {"name": "Морской", "hue": -12},
    {"name": "Арктический", "hue": -22},
    {"name": "Стальной", "hue": -10},
    {"name": "Зимний", "hue": -16},
    {"name": "Небесный", "hue": -28},
    {"name": "Аквамариновый", "hue": -14},

    # Насыщенные (21-26)
    {"name": "Виноградный", "hue": -30},
    {"name": "Лавандовый", "hue": -35},
    {"name": "Лимонный", "hue": -15},
    {"name": "Салатовый", "hue": -8},
    {"name": "Малиновый", "hue": 5},
    {"name": "Сиреневый", "hue": -32},

    # Нейтральные/Мягкие (27-30)
    {"name": "Мягкий", "hue": 3},
    {"name": "Пастельный", "hue": -4},
    {"name": "Винтажный", "hue": 7},
    {"name": "Ретро", "hue": -6},
]
...
def uniqueize_image(img, hue_shift):
    ...
    """
    # 1. ГЛАВНОЕ - Сдвиг цветовой схемы
    if hue_shift != 0:
